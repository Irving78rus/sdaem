  ...
  return (<>
    <Card  >
      <IMGContainer>
        ...
        <Gold><p>Gold</p></Gold> </IMGContainer>


      <FlexContainer flexDirection='column' padding='0 20px' alignItems='flex-start' >
      <FlexContainer width={'100%'}><p className='title'>{flat.rooms}-комн. апартаменты на {flat.city}  </p> <FlexContainer flexDirection='column' alignItems='flex-end' className='cost'> Цена: {flat.cost}  BYN <p>за сутки</p></FlexContainer></FlexContainer>
...
<div className='rooms'> {flat.rooms}   {`(${flat.rooms - 1}+1)`}  </div>
        ...
        <Button background='#F8F8F8' color='#664EF9'  fontSize='14px' padding='9px 15px' borderRadius='22px' 
        onClick={()=>setShowContact(!showContact)}>
            <img src={tel} alt='heart'></img> Контакты
          </Button>
          <Button background='rgba(235, 87, 87, 0.1)' color='#EB5757' fontSize='14px' padding='9px 15px' borderRadius='22px'>
          <img src={heart2} alt='heart'></img>В закладки
          </Button>
         
          <Button background='rgba(255, 213, 79, 0.1)' color='#FEC100;' fontSize='14px' padding='9px 15px' borderRadius='22px'>
            Подробнее
          </Button>
