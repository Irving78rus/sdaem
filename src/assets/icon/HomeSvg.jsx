...
export default function HomeSvg({ fill = '#686868',opacity='0.3',back='none' }) {
  return ( 
    
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_2831_952)">
    ...
    <path d="M10.4318 1.00195H8.06187L10.7847 3.47779V1.35483C10.7847 1.15995 10.6267 1.00195 10.4318 1.00195Z" fill="#4E64F9" />
    </g>
    <defs>
    <clipPath id="clip0_2831_952">
